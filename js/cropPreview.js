...
export function init(canvasEl, videoEl, hooks = {}) {
  ...
  titleEditor = createTitlePositionEditor({ canvas, resetButton: hooks.titleReset, layout: 'vertical' });
  resize();
...
function draw() {
  ...
  const result = text ? drawCaption(ctx, W, H, text, { layout: 'vertical', editable }) : null;
